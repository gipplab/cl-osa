...
public class SalvadorAnalysisParameters {
    ...
    public static int SUSP_FILE_SELECTION_OFFSET = 198;             // Offset selection, default 0
    ...
    public static double THRESH2 = 8.0; //0.686;      //0.086;    // Merged fragment selection thresh 0,1 too much (25) below too much 0.13
    ...
    public static int BATCHED_OFFSET_INCREMENT = 2;         // If DO_SEQUENTIAL_CALCULATAION is true, do batches of maximum size 20 suspicious files
