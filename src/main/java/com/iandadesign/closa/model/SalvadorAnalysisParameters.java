...
/**
 * Settings class for PAN-PC-11 Settings and printout functionality.
...
public class SalvadorAnalysisParameters {
    ...
    public static double THRESH2 =  0.38;                          // Merged fragment selection thresh 0,1 too much (25) below too much 0.13
