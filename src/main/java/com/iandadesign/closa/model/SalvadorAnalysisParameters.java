...
public class SalvadorAnalysisParameters {
    ...
    public static int SUSP_FILE_LIMIT = 202;                        // Only take XX supicicious files with all candidates
    ...
    public static double THRESH2 = 7.0; //0.686;      //0.086;    // Merged fragment selection thresh 0,1 too much (25) below too much 0.13
