...
public class SalvadorAnalysisParameters {
    ...
    public static int SUSP_FILE_SELECTION_OFFSET = 201;             // Offset selection, default 0
    ...
    public static double THRESH2 = 0.0; //0.686;      //0.086;    // Merged fragment selection thresh 0,1 too much (25) below too much 0.13
    ...
    public static int TOPMOST = 200;                                // topmost fetched suspicious for one plagiarism node
